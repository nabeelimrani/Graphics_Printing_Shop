    ...
    @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="mobile" class="form-control @error('mobile') is-invalid @enderror" placeholder="Mobile Number" value="{{old('mobile')}}">
                                    </div>
                                    @error('mobile')
    <span class="text-danger">{{ $message }}</span>
    @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('discount_percentage') is-invalid @enderror" name="discount_percentage" placeholder="Discount Percentage" value="{{old('discount_percentage')}}">
