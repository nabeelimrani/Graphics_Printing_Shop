                    ...
                    <div class="col-md-12 ">
                        <div class="card card-primary ">
                            ...
                            <div class="card-body bg-secondary">
                                <div class="row">
                                    <div class="col-md-6">
                                        <b class="badge badge-primary badge-lg rounded-pill">Date:
                                            {{ \Carbon\Carbon::now()->setTimezone('Asia/Karachi')->format('m/d/Y | h:i:s A') }}</b>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <b class="badge badge-primary badge-lg rounded-pill" value="{{ $random_no }}"
                                            id="codeget">No: {{ $random_no }}</b>
                                    </div>
                                </div>
                                <br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <select name="customerfield" id="customer" class="form-control">
                                                    <option value="" selected disabled>Select Customer or Find...
                                                    </option>
                                                    @foreach ($customer as $customerdata)
                                                        <option value="{{ $customerdata->id }}">{{ $customerdata->Name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group" id="categoryfield">
                                                ...
                                                <select name="categoryfield" id="category" class="form-control" disabled>
                                                    <option value="" selected disabled>Select Category or Find...
                                                    </option>
                                ...
                                <table class="table table-bordered bg-light">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center" style="padding: 0; margin: 0;">
                                                <input type="number" id="totalquantity" class="form-control text-center"
                                            ...
                                            <td class="text-center" style="padding: 0; margin: 0;">
                                                <input type="number" id="sqftSpan" readonly
                                                    class="form-control text-center" style="width: 100%; border:none;">
                                            </td>
                                            <td class="text-center" style="padding: 0; margin: 0;">
                                                <input type="number" id= "avasqrft" class="form-control text-center"
                                                    style="width: 100%; border:none;">
                                            </td>
                                            <td class="text-center" style="padding: 0; margin: 0;">
                                            ...
                                            <td class="text-center" style="padding: 0; margin: 0;">
                                                ...
                                                <button class="btn btn-success" type="submit" id="saveRow"><i
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#category").on('change', function() {
                ...
                $("#avasqrft, #showproduct, #showitemprice, #showitemdisc, #sqftSpan, #totalSpan").prop(
                    'disabled', false);
            ...
            $("#quantityInput").on("input", function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1)
                            alert(
                                "Sorry, the product is in low stock. We can't sell the requested quantity at the moment. Please contact support for assistance."
                            );
            ...
            $("#avasqrft").on("input", function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1)
                            alert(
                                "Sorry, the product is in low stock. We can't sell the requested Sqrft at the moment. Please contact support for assistance."
                            );
                        $("#saveRow").prop('disabled', true);
                        if (data == 0)
                            $("#saveRow").prop('disabled', false);
                        ...
                        if (discount > 0) {
                            ...
                            var formattedTotal = actualtotal.toFixed(2).replace(
                                /\d(?=(\d{3})+\.)/g, '$&,') + "/-";
            ...
            $("#saveRow").on('click', function() {
                ...
                newRow.append(
                    "<td class='text-center'><button class='btn btn-danger m-0 p-0 delete-row'>DEL</button> " +
                    "<button class='btn btn-primary m-0 p-0 edit-row'>EDIT</button>" + "</td>");
            ...
            $("#quantityInput,#totalquantity, #showproduct, #showitemprice, #showitemdisc, #sqftSpan, #totalSpan")
                .prop('disabled', true);
            ...
            $(document).on("click", "#submitbtn", function() {
                ...
                $('#newtd tr').each(function() {
                    ...
                    var column4 = $(this).find('td:eq(3)').text().replace('/-',
                        ''); // Fourth <td> without '/-'
                    var column5 = $(this).find('td:eq(4)').text().replace('%',
                        ''); // Fifth <td> without '%'
                    var column6 = $(this).find('td:eq(5)').text(); // Sixth <td>
                    var column7 = $(this).find('td:eq(6)').text().replace('/-',
                        ''); // Seventh <td> without '/-'
