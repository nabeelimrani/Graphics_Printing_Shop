                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="sqrft" id="sqrft"
                                                        class="form-control @error('sqrft') is-invalid @enderror"
                                                        placeholder="Enter Product Sqr.Ft" value="{{ old('sqrft') }}">
                                                </div>
                                                @error('sqrft')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="disc"
                                                        ...
                                                        placeholder="Disc%" value="{{ old('disc') }}">
                                                </div>
                                                @error('disc')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="total" class="form-control" readonly
                                                        placeholder="Total" value="" id="total">
                                                </div>
                                                @error('total')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
