    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ route('home') }}" class="brand-link d-flex align-items-center">
                <img src="{{ asset('icon/wedding.png') }}" alt="Hassan Graphics & Printing"
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('categoryview') }}"
                                        class="nav-link {{ Request::is('category/view') ? 'active' : ' ' }}">
                                        <p>View Category</p>
                                    </a>
                                </li>
                                <hr>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('productview') }}"
                                        class="nav-link {{ Request::is('product/view') ? 'active' : ' ' }}">
                                        <p>View Product</p>
                                    </a>
                                </li>
                                <hr>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('orderView') }}"
                                        class="nav-link {{ Request::is('order/view') ? 'active' : ' ' }}">
                                        <p>View Sale</p>
                                    </a>
                                </li>
                                <hr>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('areaview') }} "
                                        class="nav-link {{ Request::is('area/view') ? 'active' : ' ' }}">
                                        <p>View Area</p>
                                    </a>
                                </li>
                            </ul>
