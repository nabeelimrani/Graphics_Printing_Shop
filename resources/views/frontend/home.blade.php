      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            ...
            <a href="{{Route('productview')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-6">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="{{route('customerview')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
            ...
            <div class="card card-widget">
              <div class="card-header">
                <div class="user-block">
                  <img class="img-circle" src="{{asset('frontend/dist/img/avatar5.png')}}" alt="User Image">
  ...
  <div id="imageCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="{{asset('frontend/dist/img/wedding1.jpg')}}" alt="Photo 1">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="{{asset('frontend/dist/img/wedding2.jpg')}}" alt="Photo 2">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="{{asset('frontend/dist/img/wedding3.jpg')}}" alt="Photo 3">
      </div>
